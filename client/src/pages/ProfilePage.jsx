          ...
          <div className="flex flex-col items-center gap-4">
            <div className="relative">
              <img
                ...
                alt="Profile"
                className="block w-32 h-32 rounded-full object-cover ring-4 ring-white shadow"
              />

              <label
                htmlFor="avatar-upload"
                className={`absolute bottom-0 right-0 bg-gray-800 hover:scale-105 p-2 rounded-full cursor-pointer transition-transform duration-200 ${
